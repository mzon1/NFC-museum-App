 ...
 */
public class EX4QuizsLayout extends View {
	...
	public EX4QuizsLayout(Context context) {
		super(context);
		init(null, 0);
	}

	public EX4QuizsLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public EX4QuizsLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		final TypedArray a = getContext().obtainStyledAttributes(attrs,
				R.styleable.EX4QuizsLayout, defStyle, 0);

		mExampleString = a.getString(R.styleable.EX4QuizsLayout_exampleString);
		mExampleColor = a.getColor(R.styleable.EX4QuizsLayout_exampleColor,
				mExampleColor);
		// Use getDimensionPixelSize or getDimensionPixelOffset when dealing
		// with
		// values that should fall on pixel boundaries.
		mExampleDimension = a.getDimension(
				R.styleable.EX4QuizsLayout_exampleDimension, mExampleDimension);

		if (a.hasValue(R.styleable.EX4QuizsLayout_exampleDrawable)) {
			mExampleDrawable = a
					.getDrawable(R.styleable.EX4QuizsLayout_exampleDrawable);
